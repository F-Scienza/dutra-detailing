	...
	return (
		<div className="h-auto md:w-screen p-4 bg-white">
			...
			<div className="flex flex-wrap justify-evenly lg:grid lg:grid-cols-2 lg:place-items-center lg:justify-center lg:gap-4">
				<div
					className="flex justify-center content-center place-self-end"
				...
				<div
					className="flex justify-center md:place-self-start"
				...
				<div
					className="flex justify-center md:place-self-end"
